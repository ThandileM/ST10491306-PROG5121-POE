...
public class MessageTest {
    ...
    @BeforeEach
    public void setUp() {
        message = new Message("+27838968976", "Hello there, how are you?");
    }

    @Test
    public void testMessageIDLength() {
        assertTrue(message.checkMessageID(), "Message ID should be 10 digits or fewer");
    }

    @Test
    public void testValidRecipientNumber() {
        assertTrue(Message.checkRecipientCell("+27838968976"));
    }

    @Test
    public void testInvalidRecipientNumber() {
        assertFalse(Message.checkRecipientCell("0838968976"));
        assertFalse(Message.checkRecipientCell("+2783896"));
